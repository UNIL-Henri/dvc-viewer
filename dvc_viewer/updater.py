...
def update_dvc_yaml(project_dir: Path) -> None:
    ...
    # 1. Generate bootstrap.sh in the user's project
    bootstrap_script = project_dir / ".dvc-viewer" / "bootstrap.sh"
...
"""
    ...
    # 2. Ensure the hasher stage exists
